            ...
            <div id="formularioRegistro" class="col-12 col-md-7  cont-form">
                <form class="row g-3 needs-validation" id="myForm" novalidate action="#formularioRegistro">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="invalid-feedback">
                            Por favor ingresa el número de la reserva
                        </div>
                    </div>
                    <div class="col-md-8">
                    ...
                    <div class="col-md-6">
                        <label for="liquidacion" class="form-label">Adjuntar Liquidación</label>
                        <input required class="form-control" type="file" id="liquidacion">
                        <div class="invalid-feedback">
                            Por favor adjunta el PDF de la liquidación
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            ...
                            <div class="invalid-feedback">
                                Se requiere aceptar las políticas de tratamientos de datos y las condiciones y restricciones del sorteo.
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
